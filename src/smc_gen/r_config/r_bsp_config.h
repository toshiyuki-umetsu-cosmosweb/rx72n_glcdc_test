...
*/
#define BSP_CFG_USB_CLOCK_SOURCE        (3) /* Generated value. Do not edit this manually */
...
*/
#define BSP_CFG_PHY_CLOCK_SOURCE        (0) /* Generated value. Do not edit this manually */
...
/* PPLL Frequency Multiplication Factor Select (PPLSTC). 
   Available multipliers = x10.0 to x30.0 in 0.5 increments (e.g. 10.0, 10.5, 11.0, 11.5, ..., 29.0, 29.5, 30.0)
*/
#define BSP_CFG_PPLL_MUL                (12.0) /* Generated value. Do not edit this manually */

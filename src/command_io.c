...
static const struct cmd_entry CommandEntries[] = {
    ...
    { "backlight", "Set/get backlight duty.", cmd_backlight },
    { "display", "Display on/off", cmd_display },
    { "visible", "Set frame buffer visibility.", cmd_visible },
    { "backcolor", "Set/get background color.", cmd_backcolor },
    { "fill", "Fill frame buffer.", cmd_fill },
};
//@formatter:on
/**
 * コマンドエントリ数
